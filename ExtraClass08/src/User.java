public class User {
    ...
    /**
     * complete size of each User to save in file (per byte)
     *
     * @return
     */
    public int length() {
        return ID_LENGTH + F_NAME_SIZE_LENGTH + L_NAME_SIZE_LENGTH + CHAR_LENGTH * (fName.length() + lName.length()) + Age_LENGTH + AVG_LENGTH;
    }
}
